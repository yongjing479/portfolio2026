        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {projects.map((project, index) => (
              <div
                key={index}
                className="liquid-glass rounded-[40px] md:p-12 shadow-2xl backdrop-blur-2xl group relative flex flex-col border-2 border-border bg-card p-6 transition-all duration-300 hover:border-primary/50"
              >
                {/* Header: Label */}
                <div className="mb-4">
